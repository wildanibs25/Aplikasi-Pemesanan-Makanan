                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                <form class="form form-vertical" action="{{url('/admin/menu/insert')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12 oke">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nama Menu..."
                                                        aria-label="Username" aria-describedby="basic-addon1" name="nama_menu">
                                                </div>
                                            </div>
                                            <div class="col-12 oke">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Harga..."
                                                        aria-label="Username" aria-describedby="basic-addon1" name="harga_menu">
                                                </div>
                                            </div>
                                            <div class="col-12 oke">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="form-check" style="margin-right: 20px; padding-top:5px;">
                                                        <input class="form-check-input" type="radio" name="kategori_menu"
                                                            value="Makanan" id="flexRadioDefault1">
                                                    ...
                                                    <div class="form-check" style="margin-right: 20px; padding-top:5px;">
                                                        <input class="form-check-input" type="radio" name="kategori_menu"
                                                           value="Minuman" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="kategori_menu">
                                                            Minuman
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="col-12 oke">
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text" id="basic-addon1" style="margin-right: 20px; width:127px;">Status</span>
                                                    <div class="form-check" style="margin-right: 20px; padding-top:5px;">
                                                        <input class="form-check-input" type="radio" name="status_menu"
                                                            value="Tersedia" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="kategori_menu">
                                                            Tersedia
                                                        </label>
                                                    </div>
                                                    <div class="form-check" style="margin-right: 20px; padding-top:5px;">
                                                        <input class="form-check-input" type="radio" name="status_menu"
                                                           value="Tidak tersedia" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="kategori_menu">
                                                            Tidak tersedia
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    <div class="input-group mb-3">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="file" class="form-control" id="inputGroupFile01" name="gambar_menu">
                                                        </div>
                                                    </div>
                                                    </fieldset>
                                                </div>                  
